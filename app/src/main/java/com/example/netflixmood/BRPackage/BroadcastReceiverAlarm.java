...
import com.example.netflixmood.PagesPackage.AlarmActivity;
...
public class BroadcastReceiverAlarm extends BroadcastReceiver {
    ...
    private PendingIntent pendingIntentSnooze, pendingIntent;
    private AlarmManager alarmManagerSnooze;
    ...
    private void getBuilder(Context context, String id) {
        ...
        builder.setContentTitle("Alarm")
                .setContentText("It's time to movie")
                ...
                .addAction(R.mipmap.ic_launcher, "It's time to movie", pendingIntentSnooze);
    }
