...
import com.example.netflixmood.BRPackage.BroadcastReceiverAlarm;
        ...
        switch (v.getId()) {
            case R.id.okAlarm:
                ...
                if (myHourMy <= 9 && myMinuteMy <= 9) {
                    Toast.makeText(AlarmActivity.this, "The time you choose for alarm is: " + "0" + myHourMy + ":" + "0" + myMinuteMy, Toast.LENGTH_SHORT).show();
                } else if (myHourMy <= 9 && myMinuteMy > 9) {
                    Toast.makeText(AlarmActivity.this, "The time you choose for alarm is: " + "0" + myHourMy + ":" + myMinuteMy, Toast.LENGTH_SHORT).show();
                } else if (myHourMy > 9 && myMinuteMy > 9) {
                    Toast.makeText(AlarmActivity.this, "The time you choose for alarm is: " + myHourMy + ":" + myMinuteMy, Toast.LENGTH_SHORT).show();
                } else if (myHourMy > 9 && myMinuteMy <= 9) {
                    Toast.makeText(AlarmActivity.this, "The time you choose for alarm is: " + myHourMy + ":" + "0" + myMinuteMy, Toast.LENGTH_SHORT).show();
                }
